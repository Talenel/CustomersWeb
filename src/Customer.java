...
public class Customer {
	...
	public static ArrayList<ArrayList<String>> displayCustomers(String last)
	{
	...
	public String displayCustomer()
	{
		...
		sb.append("<p>Customer Number: "+custID+"<br>");
		sb.append(title+" "+ first+" "+last+"<br>");
		sb.append(street+"<br>");
		sb.append(city+", "+state+" "+zip+"<br>");
		sb.append(email+"<br>");
		sb.append(position+" at "+company+"<br></p>");
		return sb.toString();
	}
